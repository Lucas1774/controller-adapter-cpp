...
namespace tft {
constexpr std::array<std::pair<int, int>, 8> MOVE_COORDINATES = {
    {{483, 656}, {473, 438}, {542, 175}, {927, 180}, {1286, 198}, {1418, 476}, {1447, 671}, {956, 679}}};

constexpr std::array<std::array<std::pair<int, int>, 9>, 5> BOARD_COORDINATES = {
...
constexpr std::array<std::array<std::pair<int, int>, 10>, 2> ITEM_COORDINATES = {
...
constexpr std::array<std::pair<int, int>, 5> SHOP_COORDINATES = {
    {{503, 982}, {714, 982}, {923, 985}, {1151, 984}, {1348, 987}}};

constexpr std::array<std::array<std::pair<int, int>, 3>, 2> CARD_COORDINATES = {
    {{{{553, 580}, {963, 580}, {1380, 583}}},
     {{{552, 865}, {959, 866}, {1365, 865}}}}};

constexpr std::array<std::pair<int, int>, 3> LOCK_COORDINATES = {
