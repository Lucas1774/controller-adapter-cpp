...
g++ -c -fdiagnostics-color=always -g -Iutil -Iswarm -Itft -Ichess -Ijsoncpp-1.9.5/include -ISDL2-2.30.6/x86_64-w64-mingw32/include util/joystick.cpp -o build/joystick.o
